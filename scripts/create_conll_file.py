...
if __name__ == '__main__':
    ...
    for hit_id, tne in enumerate(tnes):
        ...
        create_conll_doc(db_path=db,
                         ...
                         hit_id=hit_id)
        # create_conll_doc(db_path="sqlite_data/hebrew_v3.dat",
        #                  original_conllu="corpus/coref_docs_2_tag/base/1_2_sents_htb_116.conllu",
        #                  tne_format="corpus/coref_docs_2_tag/tne_conll/1_2_sents_htb_116.tne",
        #                  out_path="corpus/coref_docs_2_tag/conllu_out_annotation",
        #                  hit_id=0)

#-db_dir sqlite_data -db hebrew_v3.dat -c corpus/coref_docs_2_tag/base -t corpus/coref_docs_2_tag/tne_conll -o corpus/coref_docs_2_tag/conllu_out_annotation
