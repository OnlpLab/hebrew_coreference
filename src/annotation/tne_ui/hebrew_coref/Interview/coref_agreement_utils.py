...
def two_annotators_agreement(name1, name2, keep_singletons, include_mentions, file_by_annotator,conllu_annotated_files_path ):
...
def n_annotators_agreement(annotator_names, keep_singletons, include_mentions, file_by_annotator, conllu_annotated_files_path):
    ...
    for a1_f, a2_f in file_couples:
        agreement_scores.append(calculate_average_scores(run_2_annotators_agreement(a1_f, a2_f, keep_singletons), include_mentions))
