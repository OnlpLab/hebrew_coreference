...
def parse_args():
    ...
    parser.add_argument("--train_epochs", default=150.0, type=float, help="Total number of training epochs to perform.")
    ...
    parser.add_argument("--max_tokens_in_batch", type=int, default=500)
